-- =============================================================================
-- LandChain Platform – PostgreSQL Schema
-- =============================================================================
...
-- =============================================================================
-- APPROVALS  (mutations, transfers, registrations, disputes)
-- =============================================================================
...
CREATE INDEX idx_ownership_history_property ON ownership_history(property_id);
...
CREATE INDEX idx_mortgages_bank        ON mortgages(bank_id);
